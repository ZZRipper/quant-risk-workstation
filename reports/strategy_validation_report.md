...
| STR-03 | WQ Alpha 006 - Volume Price Divergence | 0.12 | 1.16 | 1.04 | -38.13% | -20.77% | 54.1% | Watch | OOS performance is usable but needs monitoring before more capital is assigned. |
...
| STR-10 | WQ Alpha 043 - Volume Acceleration | 0.14 | 0.86 | 0.73 | -52.72% | -29.93% | 53.6% | Fail | OOS performance or drawdown indicates the signal may not generalize. |
...
| STR-20 | WQ Alpha 101 - Close To Open Reversal | 0.08 | 0.25 | 0.18 | -48.24% | -35.73% | 52.4% | Fail | OOS performance or drawdown indicates the signal may not generalize. |
